...
Load this file when you need exact syntax or a worked example for a specific diagram type.
The [Global Syntax Rules](../SKILL.md) in `SKILL.md` always apply on top of everything here.
