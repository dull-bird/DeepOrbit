...
- **Strict Filtering Rules (CRITICAL)**:
  ...
  - Absolutely exclude any path containing `99_System`.
...
- Extract the core theme, category (based on the directory it resides in, such as `10_Diary`, `20_Projects`, `40_Wiki`, etc.), and main conclusions of each note.
